...
class CfgFunctions {
    class cxp_SQL_Database {
        ...
        class MySQL {
            file = "\cxp_server\serverFunctions\MySQL";
            class numberSafe {};
            class mresArray {};
            class queryRequest {};
            class asyncCall {};
    ...
    class Cxp_System {
		...
		class Client_Functions {
			file = "\cxp_server\clientFunctions";
			class initClientFunct {preInit=1;};
		};

        class Wanted_Sys {
            file = "\cxp_server\serverFunctions\WantedSystem";
            class wantedFetch {};
            class wantedPerson {};
            class wantedBounty {};
            class wantedRemove {};
        ...
        class Jail_Sys {
            file = "\cxp_server\serverFunctions\Jail";
            class jailSys {};
      		class jailTimer {};
      		class jailPlayer {};
        };
        ...
        class BountyHunter {
            file = "\cxp_server\serverFunctions\bounty";
            class checarGlobal {};
    ...
    class CXPSV_System {
      tag = "CXPSV";
		...
		class Systems {
			file = "\cxp_server\serverFunctions\Systems";
			class isUIDActive {};
			class managesc {};
			class cleanup {};
			class huntingZone {};
		...
		class Housing {
			file = "\cxp_server\serverFunctions\Housing";
			class addHouse {};
			class addContainer {};
		...
		class Economy {
			file = "\cxp_server\serverFunctions\Economy";
			class adjustPrices {};
			class loadPrices {};
			class syncPrices {};
		};
		...
		class Gangs {
			file = "\cxp_server\serverFunctions\Gangs";
			class insertGang {};
		...
		class PlayTime {
			file = "\cxp_server\serverFunctions\PlayTime";
			class setPlayTime {};
			class getPlayTime {};
		};

  		class vAH {
  			file = "\cxp_server\serverFunctions\vAH";
  			class vAH_init {};
  			class vAH_update {};
  		};
    };
...
class CfgVehicles {
    ...
    class C_man_1 : Civilian_F {
        class EventHandlers: EventHandlers {
            init = "(_this select 0) execVM ""\cxp_server\fix_headgear.sqf""";
        };
    };
};
