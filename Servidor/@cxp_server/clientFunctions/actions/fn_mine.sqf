...
if (_requiredItem != "") then {
    _valItem = missionNamespace getVariable "cxp_inv_" + _requiredItem;
...
private _diff = [_mined, _amount, cxp_carryWeight, cxp_maxWeight] call cxp_fnc_calWeightDiff;
...
if (([true, _mined, _diff] call cxp_fnc_handleInv)) then {
