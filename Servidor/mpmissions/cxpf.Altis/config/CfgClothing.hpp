...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            { "NONE", $STR_C_Remove_uniforms, 0, "" },
			{ "U_I_G_Story_Protagonist_F", "Uniforme CT", 5000, "call cxp_coplevel = 1" }, //Transito
            { "U_Competitor", "Uniforme Recruta", 6000, "call cxp_coplevel = 2" }, //Policia Militar - Recruta
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 5000 "call cxp_coplevel = 3" }, //Policia Militar - Soldado
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 4500, "call cxp_coplevel = 4" }, //Policia Militar - Cabo
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 4000, "call cxp_coplevel = 6" }, //Policia Militar - 3ª Sargento
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 3500, "call cxp_coplevel = 7" }, //Policia Militar - 2ª Sargento
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 3000, "call cxp_coplevel = 8" }, //Policia Militar - 1ª Sargento
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 2500, "call cxp_coplevel = 9" }, //Policia Militar - SubTenente
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 2000, "call cxp_coplevel = 10" }, //Policia Militar - Aspirante
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 1500, "call cxp_coplevel = 11" }, //Policia Militar - Segundo Tenente
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 1000, "call cxp_coplevel = 12" }, //Policia Militar - Primeiro Tenente
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 900, "call cxp_coplevel = 32" }, //Policia Militar - Capitão
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 700, "call cxp_coplevel = 33" }, //Policia Militar - Major
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 800, "call cxp_coplevel = 34" }, //Policia Militar - Tenente Coronel
			{ "U_BG_Guerrila_6_1", "Uniforme PM", 500, "call cxp_coplevel = 35" }, //Policia Militar - Coronel
            { "U_Competitor", "Uniforme Recruta", 6000, "call cxp_coplevel = 12" }, //Policia Militar - Divisão ROCAM  - Recruta
            ...
            { "U_Competitor", "Uniforme Recruta", 6000, "call cxp_coplevel = 22" }, //Policia Militar - Divisão GATE  - Recruta
