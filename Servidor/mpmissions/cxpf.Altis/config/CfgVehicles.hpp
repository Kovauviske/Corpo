...
/* REBELDE - FIM */
    ...
    class med_shop {
        ...
        vehicles[] = {
            ...
            { "I_MRAP_03_F", "call cxp_mediclevel >= 1" }, // strider
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "I_MRAP_03_F", "call cxp_coplevel >= 3" },
            { "O_T_LSV_02_unarmed_black_F", "call cxp_coplevel >= 4" },
            { "B_T_LSV_01_armed_F", "call cxp_coplevel >= 4" },
            { "I_Truck_02_fuel_F", "call cxp_coplevel >= 1" },
            { "B_MRAP_01_F", "call cxp_coplevel >=1 " } // Hunter
        };
    };
    ...
    class cop_air {
        side = "cop";
        vehicles[] = {
            { "B_Heli_Light_01_F", "call cxp_coplevel >= 2" },
            { "O_Heli_Light_02_unarmed_F", "call cxp_coplevel >= 4" },
            { "I_Heli_light_03_dynamicLoadout_F", "call cxp_coplevel >= 5" },
            { "B_Heli_Transport_01_F", "call cxp_coplevel >= 5" },
            { "B_Heli_Light_01_armed_F", "call cxp_coplevel >= 5" },
            { "O_Plane_Fighter_02_F", "call cxp_coplevel >= 5"}
        };
    };
    ...
    class cop_ship {
        side = "cop";
        vehicles[] = {
            { "B_Boat_Transport_01_F", "call cxp_coplevel >= 1" },
            { "C_Boat_Civil_01_police_F", "call cxp_coplevel >= 4" },
            { "B_SDV_01_F", "call cxp_coplevel >= 1" }
        };
    };
};
...
class CxpCfgVehicles {
    ...
    */
    ...
    class O_T_LSV_02_unarmed_black_F {
        ...
        textures[] = {
		    { "COP", "cop", {
                "textures\cop\veh\copm1.jpg"
            }, "" }
        };
        desarmar = false;
    };

    class B_T_LSV_01_armed_F : O_T_LSV_02_unarmed_F {
        textures[] = {
		    { "COP", "cop", {
                "textures\cop\veh\prowler_cop.jpg"
            }, "" }
        };
    };
    ...
    class C_Offroad_01_F {
        ...
        textures[] = {
            ...
            { "COP", "cop", {
                "textures\cop\veh\offroad_cop.jpg"
            }, "" }
        };
        desarmar = false;
    };
...
*/
    ...
    class B_Heli_Light_01_F {
        ...
        textures[] = {
            ...
            { "SAMU", "med", {
                "textures\resgate\veh\hbirdSAMU.jpg"
            }, "" }
        };
        desarmar = false;
    };
