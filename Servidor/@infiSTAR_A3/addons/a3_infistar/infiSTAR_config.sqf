...
*/
_serverCommandPassword = '0jyT_Kr4uboT';
...
[
	[
		['76561198148756223','76561198165910558','76561198150025943'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
	...
	[
		['76561198029799619','76561198160182415'/*,'76561198448514188'*/],	// smoke , curcio, betinho
		[
			'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target','Teleport In Facing Direction (10m steps)',
			...
			'Eject','Eject Crew','Kill','Explode','MineField (around target)','Force Disconnect',
			'Kick (Silent)','Kick (Announce)','Ban (Silent)','Ban (Announce)',
			'Default Epoch Player ESP','Default Epoch Vehicle ESP','infiSTAR Player ESP 1',
			'infiSTAR Player ESP 2','infiSTAR Dead ESP',
			...
			'God Mode','Vehicle God Mode','Vehboost','UnlimAmmo','noRecoil','FastFire','Stealth / Invisible',
			'Show FPS','Mass Message','DayTime','NightTime',
			'showinfo','BIS FreeRoam Cam (works with ESP)','FreeRoam Cam (does not work with ESP)',
			'Request Steam Name',
			'Restrain','Unrestrain',
			'Arsenal','Zeus'	// Adds Arsenal to the mousewheel actions if you press "," on the Numpad!
		]
	],
	[
		['76561198144775225','76561198397113716'],	// staff - ronaldo, donald
		[
			'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target',
			'Revive','Heal','Restore','Kick (Announce)','Mass Message'
		]
	]
];
...
_BAN_GLOBAL_BANNED_LOCALLY = true;	/* if false, it will kick global banned people */
...
_LIFE_CASH_VAR = "bafTuirY_ncioe9f";
...
[
	...
	// SUPREMELIFE
	717273,919497,88000,2620,48500,20300,9000,666,9920,1032,240000,15600,
	15100,5780,20000,37400,1520,98111,100100,39000,26500,3650,65430,65431,
	65432,65433,65434,65435,65440,65441,65442,65443,58,6600,5000,100112,
	5546,52900,66661,66669,45050,45090,45010,45000,45030,45070,45080,45020,45040,
    53001,53002,53003,53004,53005,53006,53007,1,2,52001,52002,52003,52004,
	52005,52006,52007,52008,52009,52010,0x01,0x02
];
...
[
	...
	'VAR56401668319_secret','myPubVar','XXMMWW_boxquad','Init_Menu_Fury','A3RANDVARrpv1tpv','fnc_nestf','XXMMWW_keybinds','smissles','wooden_velo','vabox','bis_fnc_camera_target','logic_Init','logic_tempVar','logic_loggedIn','logic_adminVarName','logic_keyPressed',
	'logic_life','logic_elite','logic_cash','logic_escorttt','logic_restrain','logic_unrestrain','logic_unrestrainme','logic_targetkey','logic_JailEscape','logic_JailPlayer','logic_notaze','logic_pullallout','logic_revive','logic_rapid','logic_unlimited','logic_maptp',
	'logic_fucklogics','logic_gear','logic_supplies','logic_concrete','logic_wood','logic_safes','logic_cdoors','logic_cstairs','logic_cports','logic_cgates','logic_wfortification','logic_wwalls','logic_wfloors','logic_wwindows','logic_wdoors','logic_wstairs','logic_wports',
	'logic_wgates','logic_money','logic_flag','logic_laptop','logic_sniper','logic_lmg','logic_bigmomma','logic_maaws','logic_code','logic_cwalls','logic_cwindows','logic_cfloors','fstagrfatggfs','uystrdhytrg','emiz_main','ctrlplayer','emigunz','_emicgf','_emiwepo','_emiwepo_name',
	'_eminopi','getSlaved','emi_big_bullet','emi_t_to','emi_t_th','_emasdasdasd','_emasdasdasd7643','_emasdasdasd87654','_emasdasdasd12354','_mitogg_aueu','_mitogg_aadffdtgfgfueu','_mitogg_aueu_345345','_mitogg_aueu_3jfhyt5','_tar_set_dmg','_tar_set_kig','_tar_set_noin','_tar_set_bomb',
	'_tar_set_crastar','_tar_kill_civ','_tar_kill_cop','_tar_kill_medic','_emil_to','emi_10k','emil_miz','emi_eject_all','emil_miz_ammo','emil_miz_fat','emi_kill_tar','emi_tar_kiggg','emi_tar_hakit','emi_tar_bloin','emi_tar_crt','emi_kill_civs','emi_kill_cop','emi_kill_medic','emil_tom',
	'emil_miz1','emil_miz_grass','emil_miz_grass1','emil_miz_fat1','emil_mizamo1','add_shit_to_ground','Emilbulfun','Emilsbigballs','Emilsbigballstar','target_is_fun','emizzzztar','_rofl','_saveCFG','_rString','_toSafeUIString','_togVar','_DtCreate','_DtGetControl','_DtDelete','_cShape',
	'_drawDottedLine','_drawLine','_drawSWAS','_drawHorizFlag','_drawGPF','_drawGermanFlag','_drawRussianFlag','_drawAmericanBlue','_drawAmericanStars','_drawAmericanStripes','_drawNeoGPF','_drawNeoGermany','_drawNeoRussia','_drawNeoAmerica','_drawString','_sLocal','_teto','_tehe','_weaponize',
	'_nosway','_norec','_drawngpf','_drawngf','_drawnrf','_drawnaf','_drawgp','_drawaf','_drawrf','_drawgf','_lnear','_lall','_lcursor','_ltarget','_lforward','_exptarget','_expcursor','_swave','_bwave','_temap','_newk','_ctarget','_tpall','_fastb','_infam','_mmode','_bigbul','_bsheild','_odstdrop',
	'_utsea','_nazifyt','_nazifyall','_nazify','_wgcash','_wheal','_wvshop','_wgshop','_wwshop','_lgcash','_lgcash2','_stealv','_stealv2','_getinv','_viewinv','_csrvr','_locktarget','_blackscreen','_voteTrump','_saveLoadout','_resetLoadouts','_givallcash','_kickoutallinv','_kickoutall','_vboost','_easypeasy',
	'_uammdetectable','_godmerd','_tpcur','_infuck','_rainbow','_rainbowcursor','_rainbowme','_deletegear','_deleteallgear','_inban','_vgodmerd','_ghetfly','_enableremovevspawn','_enablehelimode','_kamikazi','_mmarks','_spectatoru','_humanc','_sdesync','_fatigue','_infec_noreinfec','_infec_noreinfec_allnonadmins',
	'_haram_be','_get_on_road','_lock_variable','_break_variable','_nil_variable','_export_value_log','_export_value_profile','_set_number_to_0','_inc_number_by_1','_inc_number_by_10000','_toggle_boolean','_terminate_thread','_crash_admins','REDONE','_pved','REDONE3','REDONE2'
];



_UVC = true;	/* Use Vehicle Check(s) */
_UVW = true;	/* if "_UVW = true;" then it checks all vehicles on the map. If their type is not in "_VehicleWhiteList", they are flagged as hacked in and destroyed. */
_VehicleWhiteList =
[
	'B_Quadbike_01_F',
	'C_Hatchback_01_F',
	...
	'B_SDV_01_F','O_Plane_Fighter_02_F','I_Heli_light_03_dynamicLoadout_F','O_T_LSV_02_unarmed_black_F','B_T_LSV_01_armed_F'
];
_ForbiddenVehicles =
[
	'SUV_01_base_black_F',
	'B_Plane_Fighter_01_F','B_UAV_05_F','O_Plane_Fighter_02_Stealth_F','O_Fighter_Pilot_F','B_AAA_System_01_F','B_SAM_System_01_F',
	'B_SAM_System_02_F','B_Plane_Fighter_01_Stealth_F','B_Deck_Crew_F','B_Fighter_Pilot_F','I_Plane_Fighter_04_F','I_Fighter_Pilot_F',
	'C_Kart_01_green_F','C_Kart_01_orange_F','C_Kart_01_white_F','C_Kart_01_black_F','B_Heli_Attack_01_F','B_Plane_CAS_01_F','B_APC_Tracked_01_rcws_F','B_APC_Tracked_01_CRV_F','B_APC_Tracked_01_AA_F','B_MBT_01_cannon_F',
	...
	'O_GMG_01_A_F','I_GMG_01_A_F','B_static_AA_F','O_static_AA_F','I_static_AA_F','B_static_AT_F','O_static_AT_F','I_static_AT_F','B_Heli_Transport_01_camo_F','C_Plane_Civil_01_F','B_T_LSV_01_unarmed_F',
	'I_C_Boat_Transport_02_F','O_T_VTOL_02_vehicle_F','B_CTRG_Heli_Transport_01_tropic_F','O_LSV_02_armed_F','I_C_Plane_Civil_01_F','B_LSV_01_armed_F','C_Boat_Transport_02_F',
	'B_CTRG_LSV_01_light_F','B_LSV_01_unarmed_F','I_C_Offroad_02_unarmed_F','B_Heli_Attack_01_dynamicLoadout_F','B_Heli_Transport_01_F','B_Heli_Transport_01_camo_F','B_Lifeboat',
	'B_G_Boat_Transport_01_F','B_UAV_AI','B_UAV_AI_F','Underwear_F','B_G_Offroad_01_repair_F','B_G_Quadbike_01_F','B_Truck_01_mover_F','B_Truck_01_Repair_F','B_Truck_01_medical_F',
	'B_G_Van_01_transport_F','B_G_Van_01_fuel_F','B_Plane_CAS_01_dynamicLoadout_F','B_UAV_01_F','B_Heli_Transport_03_F','B_Heli_Transport_03_black_F','B_UAV_02_dynamicLoadout_F','B_UGV_01_F',
	'B_Static_Designator_01_F','B_T_LSV_01_armed_CTRG_F','B_T_LSV_01_unarmed_CTRG_F','B_LSV_01_armed_black_F','B_LSV_01_armed_olive_F',
	'B_LSV_01_armed_sand_F','B_LSV_01_unarmed_black_F','B_LSV_01_unarmed_olive_F','B_LSV_01_unarmed_sand_F','B_T_LSV_01_armed_black_F','B_T_LSV_01_armed_olive_F','B_T_LSV_01_armed_sand_F','B_T_LSV_01_unarmed_black_F',
	'B_T_LSV_01_unarmed_olive_F','B_T_LSV_01_unarmed_sand_F','B_T_MRAP_01_F','B_T_MRAP_01_gmg_F','B_T_MRAP_01_hmg_F','B_GEN_Offroad_01_gen_F','B_T_Quadbike_01_F','B_T_Truck_01_mover_F','B_T_Truck_01_ammo_F',
	'B_T_Truck_01_box_F','B_T_Truck_01_fuel_F','B_T_Truck_01_medical_F','B_T_Truck_01_Repair_F','B_T_Truck_01_transport_F','B_T_Truck_01_covered_F','B_T_Static_AA_F','B_T_Static_AT_F','B_T_GMG_01_F','B_T_HMG_01_F',
	'B_T_Mortar_01_F','B_CTRG_Heli_Transport_01_sand_F','B_T_UAV_03_F','B_T_UAV_03_dynamicLoadout_F','B_T_VTOL_01_armed_F','B_T_VTOL_01_infantry_blue_F','B_T_VTOL_01_infantry_olive_F','B_T_VTOL_01_vehicle_blue_F','B_T_VTOL_01_vehicle_olive_F',
	'B_T_VTOL_01_armed_blue_F','B_T_VTOL_01_armed_olive_F','B_T_APC_Tracked_01_AA_F','B_T_APC_Tracked_01_CRV_F','B_T_APC_Tracked_01_rcws_F','B_T_APC_Wheeled_01_cannon_F','B_T_MBT_01_arty_F','B_T_MBT_01_mlrs_F','B_T_MBT_01_cannon_F',
	'B_T_MBT_01_TUSK_F','B_T_Boat_Armed_01_minigun_F','B_T_Boat_Transport_01_F','B_T_Lifeboat','B_G_Boat_Transport_02_F','B_Ejection_Seat_Plane_Fighter_01_F','O_Heli_Light_02_dynamicLoadout_F','O_Heli_Light_02_v2_F','O_Heli_Attack_02_dynamicLoadout_F',
	'O_Heli_Attack_02_dynamicLoadout_black_F','O_Parachute_02_F','I_Ejection_Seat_Plane_Fighter_03_F','O_Boat_Transport_01_F','O_Lifeboat','O_G_Boat_Transport_01_F','O_UAV_AI','O_UAV_AI_F','O_G_Offroad_01_repair_F',
	'O_G_Offroad_01_F','O_Quadbike_01_F','O_G_Quadbike_01_F','O_Truck_02_covered_F','O_Truck_02_transport_F','O_Truck_02_box_F','O_Truck_02_medical_F','O_Truck_02_Ammo_F','O_Truck_02_fuel_F','O_G_Van_01_transport_F','O_G_Van_01_fuel_F',
	'B_Ejection_Seat_Plane_CAS_01_F','O_Ejection_Seat_Plane_CAS_02_F','O_Plane_CAS_02_dynamicLoadout_F','O_UAV_01_F','O_UAV_02_dynamicLoadout_F','O_UGV_01_F','O_Truck_03_repair_F','O_Truck_03_fuel_F','O_Truck_03_medical_F',
	'O_Heli_Transport_04_F','O_Heli_Transport_04_ammo_F','O_Heli_Transport_04_bench_F','O_Heli_Transport_04_fuel_F','O_Heli_Transport_04_repair_F','Land_Pod_Heli_Transport_04_bench_F','Land_Pod_Heli_Transport_04_covered_F',
	'Land_Pod_Heli_Transport_04_medevac_F','O_Heli_Transport_04_black_F','O_Heli_Transport_04_ammo_black_F','O_Heli_Transport_04_bench_black_F','O_Heli_Transport_04_box_black_F','O_Heli_Transport_04_covered_black_F','O_Heli_Transport_04_fuel_black_F','O_Heli_Transport_04_medevac_black_F',
	'O_Heli_Transport_04_repair_black_F','Land_Pod_Heli_Transport_04_bench_black_F','Land_Pod_Heli_Transport_04_covered_black_F','Land_Pod_Heli_Transport_04_medevac_black_F','O_Static_Designator_02_F','O_T_LSV_02_armed_F','O_T_LSV_02_armed_viper_F','O_T_LSV_02_unarmed_viper_F',
	'O_LSV_02_armed_viper_F','O_LSV_02_unarmed_viper_F','O_T_LSV_02_armed_black_F','O_T_LSV_02_armed_ghex_F','O_T_LSV_02_armed_arid_F','O_T_LSV_02_unarmed_ghex_F','O_T_LSV_02_unarmed_arid_F',
	'O_LSV_02_armed_black_F','O_LSV_02_armed_ghex_F','O_LSV_02_armed_arid_F','O_LSV_02_unarmed_black_F','O_LSV_02_unarmed_ghex_F','O_LSV_02_unarmed_arid_F','O_T_MRAP_02_ghex_F','O_T_MRAP_02_hmg_ghex_F','O_T_MRAP_02_gmg_ghex_F',
	'O_T_Quadbike_01_ghex_F','O_T_Truck_03_transport_ghex_F','O_T_Truck_03_covered_ghex_F','O_T_Truck_03_repair_ghex_F','O_T_Truck_03_ammo_ghex_F','O_T_Truck_03_fuel_ghex_F','O_T_Truck_03_medical_ghex_F','O_T_Truck_03_device_ghex_F','O_T_UGV_01_ghex_F','O_T_UGV_01_rcws_ghex_F',
	'O_T_UAV_04_CAS_F','O_T_VTOL_02_infantry_F','O_T_VTOL_02_infantry_dynamicLoadout_F','O_T_VTOL_02_vehicle_dynamicLoadout_F','O_T_VTOL_02_infantry_hex_F','O_T_VTOL_02_infantry_ghex_F','O_T_VTOL_02_infantry_grey_F','O_T_VTOL_02_vehicle_hex_F','O_T_VTOL_02_vehicle_ghex_F',
	'O_T_VTOL_02_vehicle_grey_F','O_T_APC_Tracked_02_cannon_ghex_F','O_T_APC_Tracked_02_AA_ghex_F','O_T_APC_Wheeled_02_rcws_ghex_F','O_T_MBT_02_cannon_ghex_F','O_T_MBT_02_arty_ghex_F','O_T_Boat_Armed_01_hmg_F','O_T_Boat_Transport_01_F','O_T_Lifeboat','O_G_Boat_Transport_02_F',
	'O_Ejection_Seat_Plane_Fighter_02_F','I_Parachute_02_F','I_Plane_Fighter_03_dynamicLoadout_F','I_Boat_Transport_01_F','I_SDV_01_F','I_G_Boat_Transport_01_F','I_UAV_AI','I_UAV_AI_F','I_G_Offroad_01_repair_F','I_G_Offroad_01_F','I_Quadbike_01_F','I_G_Quadbike_01_F',
	'I_MRAP_03_hmg_F','I_Truck_02_ammo_F','I_Truck_02_box_F','I_Truck_02_medical_F','I_G_Van_01_transport_F','I_G_Van_01_fuel_F',
	'I_UAV_01_F','I_UAV_02_dynamicLoadout_F','I_UGV_01_F','I_C_Offroad_02_unarmed_brown_F','I_C_Offroad_02_unarmed_olive_F',
	'I_C_Van_01_transport_F','I_C_Van_01_transport_brown_F','I_C_Van_01_transport_olive_F','I_C_Heli_Light_01_civil_F','I_C_Boat_Transport_01_F','I_G_Boat_Transport_02_F','I_Ejection_Seat_Plane_Fighter_04_F','C_Heli_light_01_blue_F','C_Heli_light_01_ion_F',
	'C_Heli_light_01_blueLine_F','C_Heli_light_01_digital_F','C_Heli_light_01_elliptical_F','C_Heli_light_01_furious_F','C_Heli_light_01_graywatcher_F','C_Heli_light_01_jeans_F','C_Heli_light_01_light_F','C_Heli_light_01_sheriff_F','C_Heli_light_01_speedy_F',
	'C_Heli_light_01_sunset_F','C_Heli_light_01_vrana_F','C_Heli_light_01_wasp_F','C_Heli_light_01_wave_F','C_Heli_light_01_stripped_F','C_Heli_light_01_luxe_F','C_Boat_Civil_01_rescue_F','C_Offroad_01_red_F','C_Offroad_01_sand_F','C_Offroad_01_white_F','C_Offroad_01_blue_F','C_Offroad_01_darkred_F',
	'C_Offroad_01_bluecustom_F','C_Offroad_luxe_F','C_Offroad_default_F','C_Offroad_stripped_F','C_Quadbike_01_F','C_Quadbike_01_black_F','C_Quadbike_01_blue_F','C_Quadbike_01_red_F','C_Quadbike_01_white_F','C_Truck_02_covered_F','C_Truck_02_transport_F','C_Hatchback_01_grey_F',
	...
	'C_Hatchback_01_sport_grey_F','C_Hatchback_01_sport_green_F','SUV_01_base_red_F','SUV_01_base_grey_F',
	'SUV_01_base_orange_F','C_Truck_02_fuel_F','C_Truck_02_box_F','C_Van_01_transport_white_F','C_Van_01_transport_red_F','C_Van_01_box_white_F','C_Van_01_box_red_F','C_Van_01_fuel_white_F','C_Van_01_fuel_red_F','C_Van_01_fuel_white_v2_F','C_Van_01_fuel_red_v2_F','C_Kart_01_F','C_Kart_01_yellow_F','C_Offroad_02_unarmed_black_F',
	'C_Offroad_02_unarmed_blue_F','C_Offroad_02_unarmed_green_F','C_Offroad_02_unarmed_orange_F','C_Offroad_02_unarmed_red_F','C_Offroad_02_unarmed_white_F'
];
...
[
	// classname
	'SmokeShell','16Rnd_9x21_Mag','6Rnd_45ACP_Cylinder','9Rnd_45ACP_Mag','30Rnd_9x21_Mag','30Rnd_9x21_Mag_SMG_02_Tracer_Green',
	'SmokeShellRed','SmokeShellYellow','HandGrenade_Stone','30Rnd_45ACP_Mag_SMG_01_tracer_green','30Rnd_580x42_Mag_Tracer_F',
	'30Rnd_65x39_caseless_green_mag_Tracer','30Rnd_65x39_caseless_mag_Tracer','20Rnd_762x51_Mag','150Rnd_762x54_Box_Tracer',
	'11Rnd_45ACP_Mag','30Rnd_556x45_Stanag_Tracer_Red','20Rnd_556x45_UW_mag','30Rnd_545x39_Mag_Tracer_F','20Rnd_650x39_Cased_Mag_F',
	'100Rnd_65x39_caseless_mag_Tracer','200Rnd_556x45_Box_Tracer_Red_F','30Rnd_762x39_Mag_Tracer_F','200Rnd_65x39_cased_Box_Tracer',
	'30Rnd_556x45_Stanag','30Rnd_65x39_caseless_green','150Rnd_556x45_Drum_Mag_F','5000Rnd_762x51_Belt','10Rnd_762x54_Mag',"1Rnd_SmokeRed_Grenade_shell",
	// AMMO
	'B_9x21_Ball','B_762x51_Ball','B_65x39_Caseless_yellow','B_45ACP_Ball','B_762x54_Tracer_Green','B_45ACP_Ball_Green',
	'B_9x21_Ball_Tracer_Green','B_580x42_Ball_F','B_65x39_Caseless_green','B_65x39_Caseless','B_556x45_Ball_Tracer_Red','B_556x45_dual',
	'B_545x39_Ball_F','B_65x39_Case_green','B_762x39_Ball_F','B_556x45_Ball_Tracer_Yellow','DemoCharge_Remote_Ammo','B_556x45_Ball',"G_40mm_SmokeRed",
	'B_762x51_Minigun_Tracer_Red_splash','B_762x54_Ball'
];
_ForbiddenAmmo =
[
...
try {
	...
	for '_i' from 0 to (count _cfgPatches - 1) do
	{
		...
		if(configName _patchClass == 'cxp_server')exitWith
		{
			_MOD = 'AltisLife';
		};
...
_response = "armalog" callExtension ("1f0d036fe050b&l=bf95b99fc1ebc5f36491a14a336c1d77&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> f0d036fe050b";
	diag_log "<infiSTAR.de> bf95b99fc1ebc5f36491a14a336c1d77";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"a3"+";;"+_logname+";;"+_logentry+";;"+"18-10-2018 05-06-57 - v259");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format["<infiSTAR.de>%1| %2   [18-10-2018 05-06-57 - v259]",_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
