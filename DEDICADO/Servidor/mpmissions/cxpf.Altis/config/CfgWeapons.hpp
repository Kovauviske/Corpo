...
class WeaponShops {
    ...
    class rebel_B {
        ...
        items[] = {
            ...
            { "hgun_PDW2000_F", "", 5000, -1, "" }, //PDW 2000
            { "hgun_P07_khk_F", "", 7500, -1, "" }, //Apex DLC
            { "hgun_Pistol_heavy_01_F", "", 1000, -1, "" },
            { "SMG_01_F", "", 30000, -1, "" }, // Vermin
            { "SMG_02_F", "", 30000, -1, "" }, // Sting 9 mm
            { "SMG_05_F", "", 30000, -1, "" }, // Roque 9mm
        	{ "arifle_SDAR_F", "", 70000, -1, "" }, //Sdar Normal
            { "arifle_TRG21_F", "", 50000, -1, "" }, //TRG Normal
            { "SMG_03_black", "", 50000, -1, "" }, //Apex DLC Sniper
            { "arifle_CTAR_blk_F", "", 100000, -1, "" }, //Apex DLC Sniper
        ...
        mags[] = {
            ...
            { "30Rnd_65x39_caseless_Red", "", -1, 140, "" },
            { "10Rnd_762x54_Mag", "", 500, -1, "" },
            { "20Rnd_556x45_UW_mag", "", 60, -1, "" },
            { "30Rnd_556x45_Stanag_Tracer_Red", "", 130, -1, "" },
            { "UGL_FlareRed_F", "", 1000, -1, "" },
            { "30Rnd_9x21_Green_Mag", "", 1000, -1, "" },
