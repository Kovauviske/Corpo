...
/* REBELDE - FIM */
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "O_MRAP_02_F", "call cxp_coplevel >=1" }, // Ifrit
            { "B_MRAP_01_F", "call cxp_coplevel >=1" }, // Hunter
			{ "C_Van_02_transport_F", "call cxp_coplevel >=1" }
        };
    };
    ...
    class cop_air {
        side = "cop";
        vehicles[] = {
            { "B_Heli_Light_01_F", "call cxp_coplevel >= 2" }, //	MH-9 Hummingbird
            { "I_Heli_light_03_unarmed_F", "call cxp_coplevel >= 2" }, //WY-55 Hellcat 
            { "O_Heli_Transport_04_F", "call cxp_coplevel >= 2"} //Taru
        };
    };
    ...
    */
    ...
    class I_Heli_light_03_unarmed_F {
        ...
        textures[] = {
            ...
            { "HellCat GATE", "cop", {
                "\textures\cop\veh\hellcat_cop.jpg"
            }, "" }
        };
        desarmar = false;
    };
