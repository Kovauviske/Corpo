...
switch (playerSide) do {
    ...
    case west: {
      ...
      if (uniform player isEqualTo "I_Soldier_AAA_F" && (FETCH_CONST(cxp_coplevel) >= 1)) then {
      ...
      if (uniform player isEqualTo "U_I_G_Story_Protagonist_F" && (FETCH_CONST(cxp_coplevel) >= 1)) then {
