...
*/
private _informationFound = _this select 0;

if (count _informationFound < 1) exitWith {player setVariable ["cellphone_messages",[]];};

private _messages = _informationFound select 2;
