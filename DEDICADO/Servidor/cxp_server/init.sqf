...
fn_whoDoneIt = compile preprocessFileLineNumbers "\cxp_server\serverFunctions\Systems\fn_whoDoneIt.sqf";
...
if (EXTSQLCXP_STNG(getNumber,"HeadlessSupport") isEqualTo 1) then {[] execVM "\cxp_server\initHC.sqf";};
...
[8,true,12] execFSM "\cxp_server\FSM\timeModule.fsm";
...
[] call compile preprocessFileLineNumbers "\cxp_server\functions.sqf";
...
execVM "\cxp_server\serverFunctions\RestartAvisos\svRestMsg.sqf";
