...
_query = "SELECT id, type, amount, item, price, seller, sellername, status, time FROM ah";
_queryResult = [_query,2,true] call CXPDB_fnc_asyncCall;
...
//Parse item
{_new = [(_x select 3)] call CXPDB_fnc_mresToArray;
