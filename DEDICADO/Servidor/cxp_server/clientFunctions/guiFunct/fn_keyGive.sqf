...
_vehicle = cxp_vehicles select parseNumber(_vehicle);
...
_index = [_uid,_owners] call CXPSV_fnc_index;
...
[_vehicle,_unit,profileName] remoteExecCAll ["CXPSV_fnc_clientGetKey",_unit];
