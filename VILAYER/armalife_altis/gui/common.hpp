...
class Cxp_RscControlsGroup {
    ...
    class VScrollBar : Cxp_RscScrollBar
    {
        width = 0.021;
        autoScrollEnabled = 1;
    };

    class HScrollBar : Cxp_RscScrollBar
    {
        height = 0.028;
    };
...
class Cxp_RscControlsGroupNoScrollbars : Cxp_RscControlsGroup {
...
class Cxp_RscListNBox
{
    ...
    autoScrollDelay = 5;
    autoScrollRewind = 0;
    class ListScrollBar: Cxp_RscScrollBar{};
    class ScrollBar: Cxp_RscScrollBar{};
};
...
class Cxp_RscBackground: Cxp_RscText {
    type = 0;
    IDC = -1;
    style = 512;
    shadow = 0;
...
class Cxp_RscTitle: Cxp_RscText {
    style = 0;
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
    colorText[] = {0.95, 0.95, 0.95, 1};
};

class cxp_RscPicture {
    shadow = 0;
    type = 0;
    style = 48;
    sizeEx = 0.023;
...
class Cxp_RscTextMulti: Cxp_RscText
{
    linespacing = 1;
    style = 0 + 16 + 0x200;
};

class Cxp_RscPictureKeepAspect : Cxp_RscPicture
{
    style = 0x30 + 0x800;
};

class Cxp_RscStructuredText {
    type = 13;
    style = 0;
    x = 0;
    y = 0;
...
class Cxp_RscButtonTextOnly : Cxp_RscButton {
    SizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
    colorBackground[] = {1, 1, 1, 0};
...
class Cxp_RscButtonMenu : Cxp_RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
...
class Cxp_RscButtonInvisible : Cxp_RscButtonMenu {
...
class Cxp_RscShortcutButtonMain : Cxp_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    w = 0.313726;
...
class Cxp_RscCombo {
    ...
    class ComboScrollBar : Cxp_RscScrollBar {};
};

class Cxp_RscToolbox {
    colorText[] = {0.95, 0.95, 0.95, 1};
    color[] = {0.95, 0.95, 0.95, 1};
