...
/* Regras Iniciais Basicas -> Casperento */
  ...
  regras_basicas_menuInit_alertON[] = {
    true, // True: liga pagina extra de aviso EXTREMAMENTE importante ; False: retira tela de aviso e pula direto para as regras do proximo array (regras_basicas_menuInit)
    { // Mensagens EXTREMAMENTE importantes de serem expostas ao player antes de ele concordar com as regras!
      ...
      "Pedimos desculpas pelos demais transtornos que estamos tendo em nossa fase BETA."
    }
  };
...
/* System Settings */
  ...
  */
  ...
  patente_min_perdao_wanted = 5; // Nivel minimo para dar perdao na lista de procurado da policia [4 = Sargento]
  ...
  purchase_multiplier_umpLic = .85; // Doador Level 1 - 15% de Desconto
  purchase_multiplier_uiLic = .75; // Doador Level 2 - 25% de Desconto
  purchase_multiplier_typeLic = .5; // Doador Level 3 - 50% de Desconto
  purchase_multiplier_typeLis = .4; // Doador Level 4 - 60% de Desconto
  ...
  vehicle_rental_multiplier_umpLic = .35; // Doador Level 1 - 15% de Desconto
  vehicle_rental_multiplier_uiLic = .34; // Doador Level 1 - 15% de Desconto
  vehicle_rental_multiplier_typeLic = .33; // Doador Level 1 - 15% de Desconto
  vehicle_rental_multiplier_typeLis = .32; // Doador Level 1 - 15% de Desconto
  ...
  /* Seguro do Veiculo */
  vehicle_insurance_multiplier_umpLic = .25; // Doador Level 1 - 15% de Desconto
  vehicle_insurance_multiplier_uiLic = .20; // Doador Level 2 - 15% de Desconto
  vehicle_insurance_multiplier_typeLic = .15; // Doador Level 3 - 15% de Desconto
  vehicle_insurance_multiplier_typeLis = .10; // Doador Level 4 - 15% de Desconto
  ...
  vehicle_cop_impound_price = 20000; // quantia que o policial ganha ao apreender um veiculo
  vehicle_med_impound_price = 10000; // quantia que o medico ganha ao apreender um veiculo
