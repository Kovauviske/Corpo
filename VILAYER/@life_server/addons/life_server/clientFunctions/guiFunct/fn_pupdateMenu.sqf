...
_mstatus ctrlSetStructuredText parseText format ["<img size='1.2' image='icons\ico_money.paa'/><t size='0.8' color='#63ff00'>R$%1</t><br/><img size='1.3' image='icons\ico_bank.paa'/><t size='0.8px' color='#00ecff'>R$%2</t>",([CASH] call cxp_fnc_numberText),([BANK] call cxp_fnc_numberText)];
ctrlSetText[2009,format ["Weight: %1 / %2", cxp_carryWeight, cxp_maxWeight]];
