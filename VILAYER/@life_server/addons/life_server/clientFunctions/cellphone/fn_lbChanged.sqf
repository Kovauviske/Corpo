...
if(_data == "Você não tem nenhuma mensagem para ser lida.") then 
{
	_text ctrlSetText "Você não tem nenhuma mensagem para ser lida.";
} 
else
{
	...
	_text ctrlSetText format ["""%1"" - %2 \n \nMensagem recebida as %6:%7 no dia %3/%4/%5 . ", _message, _nameOnPList, _day, _month, _year, _hour, _minutes];
