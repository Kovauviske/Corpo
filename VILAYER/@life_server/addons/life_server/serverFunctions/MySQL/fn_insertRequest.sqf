...
/*
    ...
    Recieves information from sesison\fn_insertPlayerInfo.sqf
*/
...
if (_queryResult isEqualType "") exitWith {[] remoteExecCall ["CXPSKT_fnc_dataQuery",(owner _returnToSender)];}; //There was an entry!
if !(count _queryResult isEqualTo 0) exitWith {[] remoteExecCall ["CXPSKT_fnc_dataQuery",(owner _returnToSender)];};

//Clense and prepare some information.
_name = [_name] call CXPDB_fnc_mresString; //Clense the name of bad chars.
_alias = [[_name]] call CXPDB_fnc_mresArray;
_money = [_money] call CXPDB_fnc_numberSafe;
...
[] remoteExecCall ["CXPSKT_fnc_dataQuery",(owner _returnToSender)];
