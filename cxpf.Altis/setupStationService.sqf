...
private _stationPositions = [[["Altis", _altisPositions], ["Tanoa", _tanoaPositions]]] call CXPSV_fnc_terrainSort;

{
    ...
    _pump addAction [localize "STR_Action_Pump", cxp_fnc_fuelStatOpen, 1, 3, true, true, "", '_this distance _target < 5 && cursorObject isEqualTo _target'];
    false
